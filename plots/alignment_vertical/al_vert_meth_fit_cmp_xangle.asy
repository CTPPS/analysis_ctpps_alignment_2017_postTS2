...
string xangle_refs[];
pen xangle_pens[];
xangles.push(130); xangle_pens.push(blue);
xangles.push(150); xangle_pens.push(heavygreen);

int rp_ids[];
string rps[], rp_labels[];
real rp_y_min[], rp_y_max[];
rp_ids.push(23); rps.push("L_2_F"); rp_labels.push("L-220-fr"); rp_y_min.push(2); rp_y_max.push(3);
...
rp_ids.push(123); rps.push("R_2_F"); rp_labels.push("R-220-fr"); rp_y_min.push(1.8); rp_y_max.push(2.8);
